...
static Eet_Data_Descriptor *_descriptors[INDEX(EQU_REPLY_LAST)];
...
void equ_message_init(void)
{
	...
	edd = eet_data_descriptor_stream_new(&eddc);
	_descriptors[INDEX(EQU_MSG_HOSTS_GET)] = edd;
	/* hosts get reply */
	...
	_descriptors[INDEX(EQU_REPLY_HOSTS_GET)] = edd;
	...
	_descriptors[INDEX(EQU_MSG_CONTROLLERS_GET)] = edd;
	...
	_descriptors[INDEX(EQU_REPLY_CONTROLLERS_GET)] = edd;
	...
	_descriptors[INDEX(EQU_MSG_LAYERS_GET)] = edd;
	/* layers get reply */
	...
	_descriptors[INDEX(EQU_REPLY_LAYERS_GET)] = edd;
	/* layer caps get */
	...
	_descriptors[INDEX(EQU_MSG_LAYER_CAPS_GET)] = edd;
	...
	_descriptors[INDEX(EQU_REPLY_LAYER_CAPS_GET)] = edd;
	/* layer status get */
	...
	_descriptors[INDEX(EQU_MSG_LAYER_STATUS_GET)] = edd;
	...
	edd = eet_data_descriptor_stream_new(&eddc);
	_descriptors[INDEX(EQU_MSG_SURFACE_GET)] = edd;
	...
	_descriptors[INDEX(EQU_REPLY_SURFACE_GET)] = edd;
}
...
void equ_message_shutdown(void)
{
	...
	for (i = 0; i < INDEX(EQU_REPLY_LAST); i++)
