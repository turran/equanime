...
static Equanime_Message_Cb _cbs[EQU_MSGS_NUM] = {
	...
	[EQU_INDEX(EQU_MSG_LAYERS_GET)] = (Equanime_Message_Cb)_layers_get,
	[EQU_INDEX(EQU_MSG_LAYER_STATUS_GET)] = (Equanime_Message_Cb)_layer_status_get,
	[EQU_INDEX(EQU_MSG_LAYER_CAPS_GET)] = (Equanime_Message_Cb)_layer_caps_get,
	[EQU_INDEX(EQU_MSG_SURFACE_GET)] = (Equanime_Message_Cb)_surface_get,
 ...
 *                                   API                                      *
 *============================================================================*/
EAPI Equ_Client * equ_client_new(Eix_Client *c)
{
	Equ_Client *e;
 ...
 */
EAPI int equ_client_process(Equ_Client *c, unsigned int type, void *msg,
		void **reply)
{
	Equanime_Message_Cb cb;

	if (type > EQU_MSG_LAST)
		return EIX_ERR_NONE;
	cb = _cbs[EQU_INDEX(type)];
